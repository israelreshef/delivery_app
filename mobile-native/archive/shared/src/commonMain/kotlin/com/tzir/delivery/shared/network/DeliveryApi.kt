...
interface DeliveryApi {
    ...
    suspend fun getCourseDetails(course_id: Int): Map<String, Any>
    suspend fun completeCourseQuiz(course_id: Int, score: Int): Map<String, Any>
    ...
    // Academy Protocol Endpoints
    suspend fun getAcademyProtocolCourses(): List<Map<String, Any>>
    suspend fun getAcademyProtocolCourseContent(course_id: Int): Map<String, Any>
    suspend fun getAcademyProtocolLesson(course_id: Int, lesson_id: Int): Map<String, Any>
    suspend fun getAcademyProtocolQuizQuestions(course_id: Int): List<Map<String, Any>>
    suspend fun submitAcademyProtocolQuiz(course_id: Int, answers: List<Map<String, Int>>): Map<String, Any>
...
class DeliveryApiImpl(
    ...
    override suspend fun getGamificationLeaderboard(): List<Map<String, Any>> {
        return try {
            client.get("$baseUrl/api/couriers/gamification/leaderboard") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    override suspend fun getCourseDetails(course_id: Int): Map<String, Any> {
        return try {
            client.get("$baseUrl/api/academy/courses/$course_id") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    override suspend fun completeCourseQuiz(course_id: Int, score: Int): Map<String, Any> {
        return try {
            client.post("$baseUrl/api/academy/courses/$course_id/complete-quiz") {
                contentType(ContentType.Application.Json)
    ...
    override suspend fun getProtocolSteps(orderId: Int): List<Map<String, Any>> {
        return try {
            client.get("$baseUrl/api/orders/$orderId/protocol-steps") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    // Academy Protocol Implementations
    override suspend fun getAcademyProtocolCourses(): List<Map<String, Any>> {
        return try {
            client.get("$baseUrl/api/academy/protocols") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    override suspend fun getAcademyProtocolCourseContent(course_id: Int): Map<String, Any> {
        return try {
            client.get("$baseUrl/api/academy/protocols/$course_id") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    override suspend fun getAcademyProtocolLesson(course_id: Int, lesson_id: Int): Map<String, Any> {
        return try {
            client.get("$baseUrl/api/academy/protocols/$course_id/lessons/$lesson_id") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    override suspend fun getAcademyProtocolQuizQuestions(course_id: Int): List<Map<String, Any>> {
        return try {
            client.get("$baseUrl/api/academy/protocols/$course_id/quiz/questions") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    override suspend fun submitAcademyProtocolQuiz(course_id: Int, answers: List<Map<String, Int>>): Map<String, Any> {
        return try {
            client.post("$baseUrl/api/academy/protocols/$course_id/quiz/submit") {
                contentType(ContentType.Application.Json)
    ...
    override suspend fun getMyCertifications(): List<Map<String, Any>> {
        return try {
            client.get("$baseUrl/api/academy/protocols/my-certifications") {
                contentType(ContentType.Application.Json)
            }.body()
        } catch (e: Exception) {
            e.printStackTrace()
