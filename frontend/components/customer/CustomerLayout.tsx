...
export default function CustomerLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row" dir="rtl">
            ...
            {/* Desktop Sidebar */}
            <aside className="hidden md:flex flex-col w-64 bg-navy-950 text-white h-screen sticky top-0 z-40">
                ...
                <div className="p-4 flex flex-col gap-2 flex-1 mt-4">
                    <div className="px-4 py-2 mb-6">
                        <p className="text-xs text-navy-200 uppercase tracking-wider font-bold mb-1">שלום,</p>
                        ...
                        return (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "bg-brand text-navy-950 shadow-lg shadow-brand"
                                        : "text-navy-200 hover:bg-navy-900 hover:text-white"
                                )}
                            >
                                <Icon className={cn("w-5 h-5", isActive ? "text-white" : "text-navy-200 group-hover:text-brand/80")} />
                ...
                <div className="p-4 border-t border-navy-900 mt-auto">
                    <Button
                        onClick={logout}
                        variant="ghost"
                        className="w-full text-navy-200 hover:text-white hover:bg-red-900/20 justify-start gap-2"
            ...
            {/* Mobile Header */}
            <header className="md:hidden bg-navy-950 text-white p-4 flex items-center justify-between shadow-md sticky top-0 z-30">
