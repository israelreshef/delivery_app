        ...
        try:
            with db.engine.connect() as conn:
                ...
                try:
                    ...
                    print(f" Could not add column delivery_type (maybe exists?): {e}")
                ...
                try:
                    ...
                    print(f" Could not add column urgency (maybe exists?): {e}")
                ...
                try:
                    ...
                    print(f" Could not add column insurance_required (maybe exists?): {e}")
                ...
                try:
                    ...
                    print(f" Could not add column insurance_value (maybe exists?): {e}")
                ...
                try:
                    ...
                    print(f" Could not add column tracking_number: {e}")
                ...
                try:
                    ...
                    print(f" Could not add column pod_recipient_id: {e}")
                ...
                try:
                    ...
                    print(f" Could not add POD location columns: {e}")
