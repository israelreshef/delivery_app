...
from app.models.user import User  # Import models to ensure they are registered
...
# PostGIS Tiger geocoder tables to exclude from autogenerate
EXCLUDED_TABLES = {
    'spatial_ref_sys', 'topology', 'layer',
    'zip_lookup_base', 'zip_lookup', 'zip_lookup_all', 'zip_state', 'zip_state_loc',
    ...
    'county', 'cousub', 'state', 'place', 'tract', 'tabblock', 'tabblock20',
    'bg', 'zcta5',
